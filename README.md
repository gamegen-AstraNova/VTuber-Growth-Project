...
- 2026-09-16 已將 4 張正式 PNG 原尺寸轉為保留 alpha 的高品質 WebP，同步更新 manifest 與 JS 引用；其中原本截斷的 `bg_stream_talk.png` 經容錯解碼後重新封裝為可完整驗證的 WebP。本機 HTTP 子路徑載入無 console 警告或錯誤，重建 ZIP 由 20.95 MB 降至 13.73 MB。
